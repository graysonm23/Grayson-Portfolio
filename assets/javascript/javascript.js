...
darkModeToggle.addEventListener("click", () => {
  ...
  let background = document.getElementById("page-bg");
  let columnBgP = document.getElementById("columnBgP");
  let columnBg = document.getElementById("columnBg");
  let technical = document.getElementById("technical");
  let body = document.getElementById("body");
  let navBar = document.getElementById("navBar");
  let togglemodeText = document.getElementById("togglemodeText");
  // get their darkMode setting
  darkMode = localStorage.getItem("darkMode");
  // if it not current enabled, enable it
  background.style.height = "100vh";
  background.style.position = "fixed";
  console.log("blue d blah");
  if (darkMode !== "enabled") {
    enableDarkMode();
    document.getElementById("body").style.backgroundColor = "black";
    background.setAttribute("src", "assets/images/background-2DarkLarge.jpg");
    body.style.filter = "brightness(80%)";
    columnBg.style.backgroundColor = "rgba(255, 255, 255, 0.4)";
    technical.style.backgroundColor = "rgba(255, 255, 255, 0.4)";
    navBar.style.backgroundColor = "rgba(153, 153, 154, 0.4)";
    togglemodeText.textContent = "Light Mode";

    // if it has been enabled, turn it off
  } else {
    disableDarkMode();
    document.getElementById("body").style.backgroundColor = "white";
    background.setAttribute("src", "assets/images/background-2.jpg");
    body.style.filter = "brightness(100%)";
    columnBg.style.backgroundColor = "rgba(0, 0, 0, 0.4)";
    technical.style.backgroundColor = "rgba(0, 0, 0, 0.4)";
    navBar.style.backgroundColor = "#F8F9FA";
    togglemodeText.textContent = "Dark Mode";
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  //?-----------------------------------------contact form validation----------------------------------------------
  //!------------------------------------closing navbar with outside click------------------------------------
